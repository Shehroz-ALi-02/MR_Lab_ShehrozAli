...
def main(args=None):
    ...
    # Task 2: Coordinates (Adjust these based on your map)
    waypoints = [
        make_pose(0.5, 0.0, 0.0),   # Waypoint 1
        make_pose(1.0, 0.5, 0.0),   # Waypoint 2
        make_pose(1.0, -0.5, 0.0),  # Waypoint 3
        make_pose(0.0, -0.5, 0.0),  # Waypoint 4
        make_pose(0.0, 0.0, 0.0),   # Waypoint 5
    ]
